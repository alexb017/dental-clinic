export default function Header() {
  return (
    <header className="flex flex-col items-center justify-center gap-8 w-full max-w-[1280px] px-5">
      <div className="flex justify-center items-end bg-zinc-100 rounded-3xl w-full h-[calc(100vh-88px)] md:h-[540px] bg-[url(/images/2149164286.jpg)] bg-cover bg-center p-8">
