...
const pricing = [
  { label: 'Professional teeth cleaning', price: 100 },
  { label: 'Oral exam', price: 50 },
  { label: 'Dental X-rays', price: 150 },
  { label: 'Cavity fillings', price: 200 },
  { label: 'Tooth extraction', price: 250 },
  { label: 'Root canal therapy', price: 500 },
  { label: 'Dental crowns', price: 800 },
];
